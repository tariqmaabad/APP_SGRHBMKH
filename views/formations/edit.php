<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>Modifier la Formation Sanitaire</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form action="/APP_SGRHBMKH/formations/edit/<?= $formation['id'] ?>" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nom_formation" name="nom_formation" required 
                                   ...
                                   value="<?= htmlspecialchars($formation['nom_formation']) ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="type_formation" name="type_formation" 
                                   ...
                                   value="<?= htmlspecialchars($formation['type_formation'] ?? '') ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="province_id" name="province_id" required>
                                ...
                                <?php foreach ($provinces as $province): ?>
                                    <option value="<?= $province['id'] ?>" <?= $formation['province_id'] == $province['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="categorie_id" name="categorie_id" required>
                                ...
                                <?php foreach ($categories_etablissements as $categorie): ?>
                                    <option value="<?= $categorie['id'] ?>" <?= $formation['categorie_id'] == $categorie['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="milieu" name="milieu" required>
                                ...
                                <option value="URBAIN" <?= $formation['milieu'] === 'URBAIN' ? 'selected' : '' ?>>Urbain</option>
                                <option value="RURAL" <?= $formation['milieu'] === 'RURAL' ? 'selected' : '' ?>>Rural</option>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <dl class="row">
                    ...
                    <dd class="col-sm-9"><?= date('d/m/Y H:i', strtotime($formation['created_at'])) ?></dd>

                    <dt class="col-sm-3">Dernière modification</dt>
                    <dd class="col-sm-9"><?= date('d/m/Y H:i', strtotime($formation['updated_at'])) ?></dd>
                </dl>
            </div>
        </div>
    </div>
